!function (t, e, i, n) {
    var a = e.document, o = t(a), r = t(e), s = Array.prototype, l = 1.41, c = true, u = 3e4, h = false, f = navigator.userAgent.toLowerCase(), d = e.location.hash.replace(/#\//, ""), p = e.location.protocol, g = Math, m = function () {
    }, v = function () {
        return false
    }, y = function () {
    ...
    }, E = [], D = [], $ = false, L = false, P = [], z = [], F = function (e) {
        z.push(e);
        ...
        return {
            clearTimer: function (e) {
                ...
                n = t.extend({
                    until: v, success: m, error: function () {
        ...
        var e = function (e, i, n, a) {
            ...
            t(e.next).css(s);
            H.animate(e.next, l, {
                duration: e.speed, complete: function (t) {
                    return function () {
                        i();
                        t.css({left: 0})
                    }
            ...
            if (e.prev) {
                ...
                t(e.prev).css(s);
                H.animate(e.prev, l, {
                    duration: e.speed, queue: false, easing: o, complete: function () {
        ...
        return {
            active: false, init: function (t, e, i) {
                ...
                fade: function (e, i) {
                    ...
                    t(e.next).css({opacity: 0, left: 0});
                    if (e.prev) {
                        H.animate(e.prev, {opacity: 0}, {
                            duration: e.speed / 2, complete: function () {
                                H.animate(e.next, {opacity: 1}, {duration: e.speed, complete: i})
                            }
                        })
                    } else {
    ...
    t.event.special["click:fast"] = {
        propagate: true, add: function (i) {
            ...
            var a = {touched: false, touchdown: false, coords: {x: 0, y: 0}, evObj: {}};
            t(this).data({clickstate: a, timer: 0}).on("touchstart.fast", function (i) {
                e.clearTimeout(t(this).data("timer"));
                t(this).data("clickstate", {touched: true, touchdown: true, coords: n(i.originalEvent), evObj: i})
            }).on("touchmove.fast", function (e) {
                var i = n(e.originalEvent), a = t(this).data("clickstate"), o = Math.max(Math.abs(a.coords.x - i.x), Math.abs(a.coords.y - i.y));
                if (o > 6) {
                    t(this).data("clickstate", t.extend(a, {touchdown: false}))
                }
            }).on("touchend.fast", function (n) {
                var o = t(this), r = o.data("clickstate");
                if (r.touchdown) {
    ...
    i = function () {
        ...
        var u = this._keyboard = {
            keys: {
                ...
                BACKSPACE: 8,
                SPACE: 32
            }, map: {}, bound: false, press: function (t) {
        ...
        var h = this._controls = {
            0: n, 1: n, active: 0, swap: function () {
        ...
        var d = this._carousel = {
            ...
            animate: function (e) {
                ...
                H.animate(s.get("thumbnails"), {left: i}, {
        ...
        var p = this._tooltip = {
            ...
            move: function (t) {
                ...
                var u = s.$("container").width() - l - 2, h = s.$("container").height() - r - 2;
                if (!isNaN(a) && !isNaN(o)) {
                    a += 10;
                    o -= r + 8;
                    a = g.max(0, g.min(u, a));
        ...
        var m = this._fullscreen = {
            scrolled: 0, crop: n, active: false, prev: t(), beforeEnter: function (t) {
                t()
                ...
                var l = s.getData(), c = s._options, u = !s._options.trueFullscreen || !A.support, h = {
                    height: "100%",
                    overflow: "hidden",
                    margin: 0,
                    padding: 0
                ...
                if (l && l.big && l.image !== l.big) {
                    ...
                    var v = s.getNext(p), y = new i.Picture, w = s.getData(v);
        ...
        var v = this._idle = {
            trunk: [], bound: false, active: false, add: function (e, n, a, o) {
                if (!e || i.TOUCH) {
                    return
                }
                if (!v.bound) {
                ...
                e.data("idle", {from: t.extend(r, a), to: n, complete: true, busy: false});
                if (!o) {
                    v.addTimer()
                } else {
                    e.css(n)
                ...
                t.each(v.trunk, function (t, i) {
                    ...
                    H.animate(i, n.to, {
                        duration: s._options.idleSpeed, complete: function () {
                            if (t == e - 1) {
                                v.active = false
                            }
                        }
                ...
                if (!v.active || !n.busy && !n.complete) {
                    ...
                    s.clearTimer("idle");
                    H.animate(e, n.from, {
                        duration: s._options.idleSpeed / 2, complete: function () {
                            v.active = true;
        ...
        var w = this._lightbox = {
            ...
            init: function () {
                ...
                w.initialized = true;
                var e = "overlay box content shadow title info close prevholder prev nextholder next counter image", n = {}, a = s._options, o = "", r = "position:absolute;", l = "lightbox-", c = {
            ...
            rescale: function (e) {
                var n = g.min(r.width() - 40, w.width), a = g.min(r.height() - 60, w.height), o = g.min(n / w.width, a / w.height), l = g.round(w.width * o) + 40, c = g.round(w.height * o) + 60, u = {
                    width: l,
                    height: c,
            ...
            show: function (n) {
                ...
                r.off("resize", w.rescale);
                var a = s.getData(n), o = s.getDataLength(), l = s.getNext(n), c, u, h;
                H.hide(w.elems.info);
                try {
    ...
    i.prototype = {
        constructor: i, init: function (e, a) {
            ...
            if (s.swipe) {
                ...
                this.finger = new i.Finger(this.get("stage"), {
                    onchange: function (t) {
                        ...
                        var i = g.max(0, g.min(parseInt(e, 10), o.getDataLength() - 1)), n = o.getData(i);
            ...
            this.get("total").innerHTML = this.getDataLength();
            var o, r, s, l, c = this, u = this._options, h = n ? this._data.length - n.length : 0, f = h, d = [], p = 0, g = y < 8 ? "http://upload.wikimedia.org/wikipedia/commons/c/c0/Blank.gif" : "data:image/gif;base64,R0lGODlhAQABAPABAP///wAAACH5BAEKAAAALAAAAAABAAEAAAICRAEAOw%3D%3D", m = function () {
                var t = c.$("thumbnails").find(".active");
                if (!t.length) {
                    return false
                }
                return t.find("img").attr("src")
            }(), v = typeof u.thumbnails === "string" ? u.thumbnails.toLowerCase() : null, _ = function (t) {
            ...
            for (; this._data[h]; h++) {
                ...
                if ((u.thumbnails === true || v == "lazy") && (s.thumb || s.image)) {
                    ...
                    r.data = {width: H.parseValue(_("width")), height: H.parseValue(_("height")), order: h, src: o};
                    if (u.thumbCrop !== true) {
            ...
            var i = this, n = e.width() / 2, a = e.height() / 2, o = parseInt(e.css("left"), 10), r = parseInt(e.css("top"), 10), s = o || 0, l = r || 0, c = 0, u = 0, h = false, f = H.timestamp(), d = 0, p = 0, m = function (t, i, n) {
                if (t > 0) {
            ...
            if (r) {
                ...
                var u = this.isFullscreen() && l.big ? l.big : l.image || l.iframe, h = this._controls.slides[n], f = h.isCached(u), d = this._thumbnails[n];
                var p = {cached: f, index: n, rewind: a, imageTarget: h.image, thumbTarget: d.image, galleriaData: l};
            ...
            var l = this.isFullscreen() && r.big ? r.big : r.image || r.iframe, c = this._controls.getActive(), u = this._controls.getNext(), h = u.isCached(l), f = this._thumbnails[o.index], d = function () {
    ...
    i.Picture.prototype = {
        cache: {}, show: function () {
            ...
            var l = false, c = false, u = t(this.container), f = t(this.image), d = function () {
                if (!l) {
                    l = true;
            ...
            H.wait({
                until: function () {
                    ...
                    var i = (h - e.margin * 2) / a.original.width, n = (f - e.margin * 2) / a.original.height, o = g.min(i, n), r = g.max(i, n), s = {
                        "true": r,
                        width: i,
                        height: n,
                        "false": o,
                    ...
                    t(a.image).css({position: "absolute", top: m(u.top, "height", f), left: m(u.left, "width", h)});
                    a.show();
                    a.ready = true;
                    e.complete.call(a, a)
                }, error: function () {
