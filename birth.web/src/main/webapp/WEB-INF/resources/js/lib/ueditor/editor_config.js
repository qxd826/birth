...
(function () {
     ...
     */
    var URL;
    var img_bucketname = "img-ueditor";    //upyun图片空间名
    var file_bucketname = "file-ueditor";    //upyun文件空间名
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        , imageUrl: 'http://' + domain + BASE_PATH + '/index/upYun/upload_image'             //图片上传提交地址
        , imagePath: UPYUN_PATH
        , imageFieldName: "file"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        , maxImageSideLength: 900000                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中
        ...
        //    'justifyjustify', '|','link', '|','simpleupload', 'insertimage', 'emotion', 'scrawl', 'template',
        //    'background', '|','snapscreen', 'wordimage', '|','searchreplace']]
